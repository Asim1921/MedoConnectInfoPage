  ...
  return (
    <div className="navigation-bar">
      <ul className="navbarlist">
        ...
        <li className="opd pagenavigation">
          <a href="/">
            <img className="opd_img" src={opd} alt="" />
            OPD
          </a>
        </li>
        <li className="report pagenavigation">
          <a href="/">
            <img className="report_img" src={report} alt="" />
            Report
          </a>
        </li>
        <li className="lab pagenavigation">
          <a href="/">
            <img className="lab_img" src={lab} alt="" />
            Lab
          </a>
        </li>
